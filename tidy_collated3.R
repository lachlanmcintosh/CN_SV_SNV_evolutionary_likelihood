...
data = fread(file)
saveRDS(data, "/vast/scratch/users/lmcintosh/GD2/GD/collated_32_p128_v3_uncompressed.Rdata",compress=F)
data = readRDS("/vast/scratch/users/lmcintosh/GD2/GD/collated_32_p128_v3_uncompressed.Rdata")
...
saveRDS(alldata, "/vast/scratch/users/lmcintosh/GD2/GD/collated_32_p128_v3_final_uncompressed.Rdata",compress=F)
