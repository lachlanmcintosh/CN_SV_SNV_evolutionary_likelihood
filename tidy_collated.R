...
file = "/vast/scratch/users/lmcintosh/GD2/GD/collated_32_p128_v3.csv"
file = "/vast/scratch/users/lmcintosh/GD2/GD/temp.csv"
...
data = fread(file)
saveRDS(data, "/vast/scratch/users/lmcintosh/GD2/GD/collated_32_p128_v3.Rdata",compress = F)
data = readRDS("/vast/scratch/users/lmcintosh/GD2/GD/collated_32_p128_v3.Rdata",compress = F)
...
saveRDS(alldata, "/vast/scratch/users/lmcintosh/GD2/GD/collated_32_p128_v3_final.Rdata", mc.cores = min(parallel::detectCores(), 4))

alldata = readRDS("/vast/scratch/users/lmcintosh/GD2/GD/collated_32_p128_v3_final_uncompressed.Rdata")
dim(alldata)
